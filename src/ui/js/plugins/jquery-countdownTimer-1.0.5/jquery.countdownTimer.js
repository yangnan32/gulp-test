...
(function( $ ) {
    ...
    function givenDate($this, opts, type) {
        ...
        if((endDate - startDate) > 0) {
            ...
            $this.html(days+opts.daySeparator+hours+opts.hourSeparator+minutes+opts.secondSeparator+seconds);
            ...
            $this.html("00"+opts.daySeparator+"00"+opts.hourSeparator+"00"+opts.secondSeparator+"00");
            if(type == "withnoStart") {
